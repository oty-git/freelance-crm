...
export default {
    ...
    temporary_approve: {label: <Trans>Temporary Approved</Trans>, class: 'text-temporary'},
    waiting_for_approval: {label: <Trans>Waiting for approval</Trans>, class: 'text-whating-yellow'},
