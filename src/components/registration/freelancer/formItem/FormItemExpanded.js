...
const FormItemExpanded = ({
  ...
  const [isCalculationType, setIsCalculationType] = useState(
  ...
  const handleAddRow = (e) => {
    ...
    newParentState["AccountToServices"][serviceIndex][
      "AccountServicesLanguages"
    ].push({
      languages_from_id: languages[0].id,
      languages_to_id: service.interpreting ? languages[0].id : null,
      price: 0,
    });
  ...
  let rows =
    parentState &&
    parentState["AccountToServices"] &&
    parentState["AccountToServices"][serviceIndex]
      ? parentState["AccountToServices"][serviceIndex][
          "AccountServicesLanguages"
        ]
      : [];
  ...
  return (
    <div>
              ...
              <div className="col-12 col-md-6">
                <div className="form-group">
                  ...
                  <SelectInput
                    ...
                    placeholder={
                      !isCalculationType
                        ? t("Please select price calculation type")
                        : false
                    }
                  />
                </div>
            ...
            {!service.language_selection && (
              <div className="col-12 col-md-6">
                <div className="form-group">
                  <div className="form-group__header">
                    <p>
                      {service.price_calculation_units ||
                      parentState["AccountToServices"][serviceIndex][
                  ...
                  <input
                    className="input input--alabaster"
                    type="number"
                    name={"price"}
                    placeholder="0.00"
      ...
      {(service.price_calculation_type || isCalculationType) &&
      service.language_selection ? (
        <React.Fragment>
          {rows.map((item, index) => {
            return (
