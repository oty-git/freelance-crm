...
const FormBlocksWrapper = ({step, parentState, setParentState, errors}) => {
    ...
    const firstStep = () => {
        return <React.Fragment>
            ...
            {services ? services.map((service, index) => {
                return <FormItem key={index} service={service} index={index} parentState={parentState} setParentState={setParentState}/>
            }) : ''}
    ...
    const secondStep = () => {
        return <React.Fragment>
            ...
            <DiplomaBlock parentState={parentState} setParentState={setParentState}/>
            <FileUploadBlock parentState={parentState} setParentState={setParentState}/>
            <ExpertisesBlock parentState={parentState} setParentState={setParentState}/>
        </React.Fragment>
    };
    ...
    const thirdStep = () => {
        return <React.Fragment>
                    ...
                    <div className="application-form__card-line">
                        <div className="row">
                            <div className="col-12 col-md-6">
                                <PersonInputsBlock parentState={parentState} setParentState={setParentState} errors={errors}/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="application-form__item">
                <div className="application-form__card">
                    <div className="application-form__card-line">
                        <BankDetailsBlock parentState={parentState} setParentState={setParentState}/>
                    </div>
                </div>
            </div>
            <div className="application-form__item">
