...
const Dropdown = ({ headerTitle, items }) => {
  ...
  return (
    <div
      className={
        "dropdown notifications-dropdown js-dropdown" +
        (isOpen ? " is-active" : "")
      }
    ...
    >
      ...
      />
      <div
        className="dropdown__box notifications-dropdown__box"
        style={{ display: isOpen ? "block" : "none" }}
      >
        <div className="notifications-dropdown__wrap">
          <DropdownHeader title={headerTitle} />
          <div
            className="custom-scroll notifications-dropdown__scroll"
...
const DropdownButton = ({ count, setIsOpen, isOpen }) => {
  return (
    <div
      className="dropdown__toggle notifications-dropdown__toggle"
    ...
    >
      <div className="notifications-dropdown__toggle-icon">
        <svg className="svg-icon svg-icon--surfie-green" width="24" height="25">
          <use
            href="/images/svg/svg-sprite/symbol/sprite.svg#bell"
            x="0"
            y="0"
          ></use>
        </svg>
