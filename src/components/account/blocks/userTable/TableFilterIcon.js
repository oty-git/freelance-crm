const TableFilterIcon = () => {
    return <div className="catalog__right catalog__right--ml-auto">
        <button className="button button--white button__filter" type="button" data-content-toggle-button="filters">
