...
const UserDropdown = () => {
  ...
  return (
    <div
      className={
        "dropdown user-dropdown js-dropdown" + (isOpen ? " is-active" : "")
      }
      data-dropdown="user"
    >
      <div
        className="dropdown__toggle user-dropdown__toggle"
      ...
      >
        ...
        <div className="user-dropdown__toggle-name">
          {user && user[userType] && user[userType].name}
        </div>
        <div className="user-dropdown__toggle-chevron">
          <svg className="svg-icon svg-icon--surfie-green" width="9" height="5">
            <use
              href="/images/svg/svg-sprite/symbol/sprite.svg#chevron-down"
              x="0"
              y="0"
            ></use>
          </svg>
      ...
      <div
        className="dropdown__box user-dropdown__box"
    ...
    <div className="user-dropdown-menu">
      <div className="user-dropdown-menu__items">
        <div className="user-dropdown-menu__item">
          <Link
            className="user-dropdown-menu__link "
            to={"/settings"}
          ...
          >
            <div className="user-dropdown-menu__icon">
              ...
              >
                <use
                  href="/images/svg/svg-sprite/symbol/sprite.svg#cog"
                  x="0"
                  y="0"
                ></use>
              </svg>
        ...
        <div className="user-dropdown-menu__item">
          ...
          >
            <div className="user-dropdown-menu__icon">
              ...
              >
                <use
                  href="/images/svg/svg-sprite/symbol/sprite.svg#log-out"
                  x="0"
                  y="0"
                ></use>
              </svg>
