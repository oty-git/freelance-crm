...
const TdMoreItems = ({ data, name, value }) => {
  ...
  return (
    <td className={"center__stat"} ref={node}>
      {!!(data && data.length) && (
        <React.Fragment>
          <div className="row-group row-group--nowrap row-group--sm row-group--justify-start-important">
            <div className="row-group__item">
              <p>
                ...
                <span
                  className={
                    data[0][value].toString()?.indexOf("-") !== -1
                      ? "text-brick-red"
                      : "text-surfie-green"
                  }
                >
            ...
            <div className="row-group__item ">
              {data.length > 1 && (
                <button
                  className="button button--shadow button--white button--size-30"
                  type="button"
                ...
                >
                  ...
                  >
                    <use
                      href="/images/svg/svg-sprite/symbol/sprite.svg#eye"
                      x="0"
                      y="0"
                    ></use>
                  </svg>
          ...
          {!!show && (
            <div className="float__fee">
              {data.map((item) => {
                return (
                  <div key={item.id} className="elem__fee ">
                    <p>
                      {item[name]} (
                      <span
                        className={
