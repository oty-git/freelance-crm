...
const RepetitionsBlock = ({
  ...
  const handleAddRow = (e) => {
    e.preventDefault();
    parentState["AccountServicesDiscounts"].push({
      repetitions: "",
      discount: "",
    });
    ...
    <div className="row__form row__form--group col_4">
      <div className="form-group">
        ...
        <ModalFormInput
          ...
          className={"repeatitions__field"}
          styles={{ minWidth: "70px" }}
          arrayIndex={index}
          arrayName={"AccountServicesDiscounts"}
