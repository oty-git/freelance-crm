...
const ModalChangePassword = ({modalShow, setModalShow,user, showEmail=false, showForgotButton=false}) => {
    ...
    return <React.Fragment>
        ...
        <div className="password-change-modal__wrap">
            ...
            <div className="password-change-modal__text">
                <p>{email ? t('Reset password information.')  :t('Changing password information.')}</p>
            </div>
                ...
                <form className="form" onSubmit={e => onSubmit(e)}>
                    ...
                    <div className="form__line">
                        <div className="input-animation js-input-animation input-animation--required">
                            <FormInput name={'current_password'} label={t('Old password')} id={'oldPassword'} type={'password'} isRequired={true}/>
                        </div>
                    </div>
                    <div className="form__line">
                        <div className="input-animation js-input-animation input-animation--required">
                            <FormInput name={'password'} label={t('New password')} id={'newPassword'} type={'password'} isRequired={true}/>
                        </div>
                    </div>
                    <div className="form__line">
                        <div className="input-animation js-input-animation input-animation--required">
                            <FormInput name={'repassword'} label={t('Repeat new password')} id={'repeatPassword'} type={'password'} isRequired={true}/>
                        </div>
                    </div>
                    </>
                    }
                    ...
                    <div className="form__line">
                        <div className="input-animation js-input-animation input-animation--required">
                            <FormInput name={'email'} label={t('Email')} id={'Email'} type={'text'} isRequired={true}/>
                        </div>
                    </div>
                    }
                    ...
                    <div className="form__line">
                        <div className="password-change-modal__buttons">
                            <div className="button-group button-group--column">
                                <button className="button button--surfie-green button-group__button" type="submit"
                                        data-modal-open="password-change-success-modal">{
                                    email ? t("Confirm password reset") :  t("Confirm new password")
                                        }
                                </button>
                                <button className="button button--transparent button-group__button" type="button"
                                        data-modal-close="password-change-modal" onClick={e => setModalShow(false)}>{t("Cancel")}
                                </button>
                            </div>
                        </div>
                    </div>
