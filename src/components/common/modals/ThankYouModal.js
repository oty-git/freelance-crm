...
const ThankYouModal = ({modalShow, setSuccessModal}) => {
    ...
    return <Modal open={modalShow}
        ...
        <div className="registration-success-modal__wrap">
            <div className="registration-success-modal__icon"><img src="/images/icons/check-circle.svg" alt="check"/>
            </div>
            ...
            <div className="registration-success-modal__text">
                <p>{t("You will be noticed by email when your account will be activated.")}</p>
            </div>
            <div className="registration-success-modal__button">
                <button onClick={()=>{
                    history.push("/");
                }} className="button button--border-surfie-green" type="button"
                        data-modal-close="registration-success-modal">{t("Back to home page")}
                </button>
            </div>
        </div>
    </Modal>;
