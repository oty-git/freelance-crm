...
const ModalEditAvatar = ({modalShow, setModalShow,user,userType,src,...props}) => {
    const styles = {
        width: '100%',
        maxWidth: '700px',
        margin: '10px auto',
    ...
    return <Modal open={modalShow}
        ...
        <div className="edit-avatar-modal__body">
            <AvatarImageInput user={user} userType={userType} src={src} setModalShow={setModalShow} {...props}/>
        </div>
    </Modal>
};
