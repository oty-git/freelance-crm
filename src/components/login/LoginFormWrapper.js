...
const LoginFormWrapper = () => {
    ...
    return <div className="login-page__box">
        <div className="form-box">
            <div className="form-box__header">
                <div className="form-box__icon"><img src="/images/logo.svg" alt="logo"/></div>
            ...
            {loading ?
                ...
                <React.Fragment>
                    ...
                    <div className="form-box__footer">
                        <Link to={'/registration/freelancer'} className={'link link--underline'}>{t('Create an account')}</Link>
                    </div>
                </React.Fragment>
            }
        </div>
